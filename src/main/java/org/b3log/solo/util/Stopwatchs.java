 ...
 * @see org.b3log.solo.util.Stopwatchs.Stopwatch
...
public final class Stopwatchs {
     ...
     * @return
     * <ul>
     * <li>{@linkplain org.b3log.solo.util.Stopwatchs.Stopwatch#getElapsedTime() elapsed time} of the found task if it
     * {@linkplain org.b3log.solo.util.Stopwatchs.Stopwatch#isEnded() is ended}</li>
     * <li>{@linkplain System#currentTimeMillis() the current time} subtracts
     * {@linkplain org.b3log.solo.util.Stopwatchs.Stopwatch#startTime the start time} of the found task if it
     * {@linkplain org.b3log.solo.util.Stopwatchs.Stopwatch#isRunning() is running} </li>
