...
public abstract class AbstractJdbcDatabaseSolution implements JdbcDatabase {
	 ...
	 *            table name
	 */
	protected abstract void createDropTableSql(StringBuilder dropTableSql, String tableName);
	 ...
	 *            table name
	 */
	protected abstract void createTableHead(StringBuilder createTableSql, String tableName);
	 ...
	 */
	protected abstract void createTableBody(StringBuilder createTableSql, List<FieldDefinition> fieldDefinitions);
