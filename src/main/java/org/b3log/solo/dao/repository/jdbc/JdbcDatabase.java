...
public interface JdbcDatabase {
	 ...
	 *            ifdrop
	 *            <P>
	 *            ifdrop true: using drop not: using truncate to clear data.
	 *            </p>
	 * @throws SQLException
	 *             SQLException
	 ...
	 * @return sql
	 */
	String queryPage(int start, int end, String selectSql, String filterSql, String orderBySql, String tableName);
