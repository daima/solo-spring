 ...
 *
 * <p>
 * If business processing failed, the {@link #successful} should be
 * {@code false}.
 * </p>
 *
 * @param <T>
...
public final class ServiceResult<T> {
	 ...
	 * 
	 * @return {@code true} if it is successful, returns {@code false} otherwise
	 */
