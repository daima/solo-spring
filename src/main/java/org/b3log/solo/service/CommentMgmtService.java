...
//        final Transaction transaction = commentDao.beginTransaction();
        ...
        try {
            ...
            pageCommentReplyNotifier.action(new Event<JSONObject>(EventTypes.ADD_COMMENT_TO_PAGE, eventData));
...
//        final Transaction transaction = commentDao.beginTransaction();
        ...
        try {
            ...
            symphonyCommentSender.action(new Event<JSONObject>(EventTypes.ADD_COMMENT_TO_ARTICLE, eventData));
//            transaction.commit();
        } catch (final Exception e) {
//            if (transaction.isActive()) {
//                transaction.rollback();
