...
public abstract class AbstractPlugin implements Serializable {
    ...
    *//**
     ...
     * @param args args
     */
    public abstract void prePlug(final HttpServletRequest request, final HttpServletResponse response, final Map<String, Object> args);
     ...
     * @param ret ret
     */
    public abstract void postPlug(Map<String, Object> dataModel, final HttpServletRequest request, final HttpServletResponse response, Object ret);
    ...
    *//**
     ...
     * @param ret ret
     */
    public void plug(final Map<String, Object> dataModel, final HttpServletRequest request, final HttpServletResponse response, final Object ret) {
