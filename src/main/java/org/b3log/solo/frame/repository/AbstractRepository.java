            ...
            switch (runtimeEnv) {
                case LOCAL:
                    ...
                    switch (runtimeDatabase) {
                        ...
                        case H2:
                        case MSSQL:
                            repositoryClass = (Class<Repository>) Class.forName("org.b3log.solo.frame.repository.jdbc.JdbcRepository");

                            break;
                        case REDIS:
                            repositoryClass = (Class<Repository>) Class.forName("org.b3log.solo.frame.repository.redis.RedisRepository");

                            break;
                        case NONE:
                            repositoryClass = (Class<Repository>) Class.forName("org.b3log.solo.frame.repository.NoneRepository");
