...
import org.b3log.solo.frame.repository.KeyGenerator;
import org.b3log.solo.frame.repository.Projection;
import org.b3log.solo.frame.repository.PropertyFilter;
import org.b3log.solo.frame.repository.Query;
import org.b3log.solo.frame.repository.Repository;
...
public abstract class JdbcRepository implements Repository {
	...
	static {
		...
		if (Strings.isEmptyOrNull(value) || "org.b3log.solo.frame.repository.TimeMillisKeyGenerator".equals(value)) {
