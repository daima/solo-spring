 ...
 */
package org.b3log.solo.frame.ioc.inject;
 ...
 *
 * <p>Injectable constructors are annotated with {@code @Autowired} and accept
 * zero or more dependencies as arguments. {@code @Autowired} can apply to at most
 * one constructor per class.
 *
 * <p><tt><blockquote style="padding-left: 2em; text-indent: -2em;">@Autowired
 ...
 *
 * <p>{@code @Autowired} is optional for public, no-argument constructors when no
 ...
 * <p>Injectable fields:
 * <ul>
 *   <li>are annotated with {@code @Autowired}.
 *   <li>are not final.
 ...
 * <ul>
 *   <li>are annotated with {@code @Autowired}.</li>
 ...
 *   }</pre>
 *
 * <p>A method annotated with {@code @Autowired} that overrides another method
 * annotated with {@code @Autowired} will only be injected once per injection
 * request per instance. A method with <i>no</i> {@code @Autowired} annotation
 * that overrides a method annotated with {@code @Autowired} will not be
 * injected.
 *
 * <p>Injection of members annotated with {@code @Autowired} is required. While an
 ...
 * inject. Qualifiers are optional, and when used with {@code @Autowired} in
