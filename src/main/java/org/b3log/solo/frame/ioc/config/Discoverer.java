...
import org.b3log.solo.frame.servlet.ClassPathResolver;
import org.springframework.stereotype.Controller;
import org.b3log.solo.util.AntPathMatcher;
import org.b3log.solo.util.ArrayUtils;
...
public final class Discoverer {
     ...
     */
    private static final String[] BUILT_IN_COMPONENT_PKGS = new String[] {"org.b3log.solo.remote"};
    ...
    public static Collection<Class<?>> discover(final String scanPath) throws Exception {
        ...
        for (URL url : urls) {
            ...
            for (final Annotation annotation : annotations) {
                if (annotation.getTypeName().equals(Controller.class.getName())) {
