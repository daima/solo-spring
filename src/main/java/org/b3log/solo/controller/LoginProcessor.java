...
//        transaction.commit();
     ...
     * @throws ServiceException the ServiceException
     */
    private void renderPage(final HttpServletRequest request, final HttpServletResponse response, final String pageTemplate, final String destinationURL) throws JSONException, ServiceException {
