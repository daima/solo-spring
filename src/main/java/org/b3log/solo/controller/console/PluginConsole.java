...
public class PluginConsole {
	 ...
	 */
	@RequestMapping(value = "/console/plugins/*/*/*"/*
													 * Requests.
													 * PAGINATION_PATH_PATTERN
													 */, method = RequestMethod.GET)
	public void getPlugins(final HttpServletRequest request, final HttpServletResponse response) throws Exception {
	 ...
	 *            the specified http request context
	 * @param renderer
	 *            the specified {@link ConsoleRenderer}
	 * @throws Exception
	 *             exception
	 */
